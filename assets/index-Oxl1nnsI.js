...
`;function ch(e,t,n){switch(n){case"bottom-left":return t?qm:Mm;case"bottom-right":return t?bm:$m;case"down":return e?t?th:Fm:t?eh:Dm;case"left":return e?t?rh:Am:t?nh:ia;case"right":return e?t?oh:Um:t?lh:Bm;case"top-left":return t?ih:Vm;case"top-right":return t?sh:Wm;case"up":return e?t?uh:Qm:t?ah:Hm;default:return t?Jm:Im}}const Dl=e=>{const{big:t=!1,direction:n,reverse:r=!1,...l}=e,o=L.useMemo(()=>ch(t,r,n),[t,n,r]);return re(yd,{keyframes:o,...l})};k`
  from {
