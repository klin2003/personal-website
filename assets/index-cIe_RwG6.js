 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,O){var L=N.length;N.push(O);e:for(;0<L;){var K=L-1>>>1,re=N[K];if(0<o(re,O))N[K]=O,N[L]=re,L=K;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var O=N[0],L=N.pop();if(L!==O){N[0]=L;e:for(var K=0,re=N.length,Nr=re>>>1;K<Nr;){var Rt=2*(K+1)-1,El=N[Rt],$t=Rt+1,Pr=N[$t];if(0>o(El,L))$t<re&&0>o(Pr,El)?(N[K]=Pr,N[$t]=L,K=$t):(N[K]=El,N[Rt]=L,K=Rt);else if($t<re&&0>o(Pr,L))N[K]=Pr,N[$t]=L,K=$t;else break e}}return O}function o(N,O){var L=N.sortIndex-O.sortIndex;return L!==0?L:N.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],c=[],g=1,m=null,h=3,w=!1,S=!1,v=!1,z=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(N){for(var O=n(c);O!==null;){if(O.callback===null)r(c);else if(O.startTime<=N)r(c),O.sortIndex=O.expirationTime,t(a,O);else break;O=n(c)}}function y(N){if(v=!1,d(N),!S)if(n(a)!==null)S=!0,jl(j);else{var O=n(c);O!==null&&Cl(y,O.startTime-N)}}function j(N,O){S=!1,v&&(v=!1,f(P),P=-1),w=!0;var L=h;try{for(d(O),m=n(a);m!==null&&(!(m.expirationTime>O)||N&&!Ve());){var K=m.callback;if(typeof K=="function"){m.callback=null,h=m.priorityLevel;var re=K(m.expirationTime<=O);O=e.unstable_now(),typeof re=="function"?m.callback=re:m===n(a)&&r(a),d(O)}else r(a);m=n(a)}if(m!==null)var Nr=!0;else{var Rt=n(c);Rt!==null&&Cl(y,Rt.startTime-O),Nr=!1}return Nr}finally{m=null,h=L,w=!1}}var C=!1,k=null,P=-1,X=5,I=-1;function Ve(){return!(e.unstable_now()-I<X)}function On(){if(k!==null){var N=e.unstable_now();I=N;var O=!0;try{O=k(!0,N)}finally{O?Tn():(C=!1,k=null)}}else C=!1}var Tn;if(typeof u=="function")Tn=function(){u(On)};else if(typeof MessageChannel<"u"){var ia=new MessageChannel,_d=ia.port2;ia.port1.onmessage=On,Tn=function(){_d.postMessage(null)}}else Tn=function(){z(On,0)};function jl(N){k=N,C||(C=!0,Tn())}function Cl(N,O){P=z(function(){N(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){S||w||(S=!0,jl(j))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(N){switch(h){case 1:case 2:case 3:var O=3;break;default:O=h}var L=h;h=O;try{return N()}finally{h=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,O){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var L=h;h=N;try{return O()}finally{h=L}},e.unstable_scheduleCallback=function(N,O,L){var K=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?K+L:K):L=K,N){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=L+re,N={id:g++,callback:O,priorityLevel:N,startTime:L,expirationTime:re,sortIndex:-1},L>K?(N.sortIndex=L,t(c,N),n(a)===null&&N===n(c)&&(v?(f(P),P=-1):v=!0,Cl(y,L-K))):(N.sortIndex=re,t(a,N),S||w||(S=!0,jl(j))),N},e.unstable_shouldYield=Ve,e.unstable_wrapCallback=function(N){var O=h;return function(){var L=h;h=O;try{return N.apply(this,arguments)}finally{h=L}}}})(Hu);Vu.exports=Hu;var Gd=Vu.exports;/**
 * @license React
...
`;function mh(e,t,n){switch(n){case"bottom-left":return t?nh:A1;case"bottom-right":return t?rh:B1;case"down":return e?t?lh:V1:t?oh:U1;case"left":return e?t?sh:H1:t?ih:la;case"right":return e?t?uh:Q1:t?ah:W1;case"top-left":return t?ch:G1;case"top-right":return t?fh:Y1;case"up":return e?t?ph:X1:t?dh:b1;default:return t?th:F1}}const Sd=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,l=T.useMemo(()=>mh(t,r,n),[t,n,r]);return oe(yd,{keyframes:l,...o})};_`
  from {
