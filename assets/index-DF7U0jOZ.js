...
`;function fh(e,t,n){switch(n){case"bottom-left":return t?qm:$m;case"bottom-right":return t?eh:Dm;case"down":return e?t?nh:Am:t?th:Fm;case"left":return e?t?lh:Bm:t?rh:oa;case"right":return e?t?ih:Vm:t?oh:Um;case"top-left":return t?sh:Wm;case"top-right":return t?ah:Hm;case"up":return e?t?ch:Ym:t?uh:Qm;default:return t?Jm:Im}}const yd=e=>{const{big:t=!1,direction:n,reverse:r=!1,...l}=e,o=L.useMemo(()=>fh(t,r,n),[t,n,r]);return re(gd,{keyframes:o,...l})};_`
  from {
